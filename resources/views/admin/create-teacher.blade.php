...
@section('content')
    <div class="container">
        <form action="{{ route('createTeacher') }}" method="POST" name="create_teacher" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="video">Introducing video</label>
            ...
            <select class="custom-select custom-select-md mb-3" name="subject" id="subject">
                <option value="1">XZ</option>
                <option value="2">ZZ</option>
            </select>
            ...
            <select class="custom-select custom-select-md mb-3" id="nationality"></select>
            ...
            <div class="form-group">
                ...
                <input type="text" name="years" class="form-control" id="years" placeholder="Enter teacher's years of teaching experience">
            </div>

            <div class="form-group">
                <label for="salary">Salary expectation</label>
                <input type="text" name="salary" class="form-control" id="salary" placeholder="Enter teacher's salary expectation">
            </div>
